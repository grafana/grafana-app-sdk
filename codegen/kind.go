...
type KindCodegenProperties struct {
    ...
    Java   KindCodegenLanguageProperties[KindCodegenJavaConfig]   `json:"java"`
    Python KindCodegenLanguageProperties[KindCodegenPythonConfig] `json:"python"`
    PHP    KindCodegenLanguageProperties[KindCodegenPHPConfig]    `json:"php"`
}
...
// KindCodegenJavaConfig is the Go configuration options for codegen,
// modeled after the cog Go codegen options.
type KindCodegenJavaConfig struct {
}

// KindCodegenPHPConfig is the Go configuration options for codegen,
// modeled after the cog Go codegen options.
type KindCodegenPHPConfig struct {
}

// KindCodegenPythonConfig is the Go configuration options for codegen,
// modeled after the cog Go codegen options.
type KindCodegenPythonConfig struct {
}
