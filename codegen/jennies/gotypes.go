...
func GoTypesFromCUE(v cue.Value, cfg CUEGoConfig, maxNamingDepth int, openAPIModelNamerFunc func(string) string) ([]byte, error) {
	...
	codegenPipeline := cog.TypesFromSchema().
		...
		Golang(cog.GoConfig{
			...
			OpenAPIModelNamerFunc: openAPIModelNamerFunc,
		})
