...
func TestWebhookServer_AddMutatingAdmissionController(t *testing.T) {
	...
	sch1 := resource.Kind{
		Schema: resource.NewSimpleSchema("foo", "v1", &TestResourceObject{}, &resource.TypedList[*TestResourceObject]{}, resource.WithKind("bar")),
		Codecs: map[resource.KindEncoding]resource.Codec{resource.KindEncodingJSON: resource.NewJSONCodec()},
	}
	sch2 := resource.Kind{
		Schema: resource.NewSimpleSchema("bar", "v1", &TestResourceObject{}, &resource.TypedList[*TestResourceObject]{}, resource.WithKind("foo")),
		Codecs: map[resource.KindEncoding]resource.Codec{resource.KindEncodingJSON: resource.NewJSONCodec()},
	}
