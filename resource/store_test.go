...
func TestNewStore(t *testing.T) {
	...
	t.Run("register groups", func(t *testing.T) {
		g1s1 := Kind{NewSimpleSchema("g1", "1", &TypedSpecObject[any]{}, &TypedList[*TypedSpecObject[any]]{}, WithKind("g1s1")), map[KindEncoding]Codec{KindEncodingJSON: &JSONCodec{}}}
		g1s2 := Kind{NewSimpleSchema("g1", "2", &TypedSpecObject[any]{}, &TypedList[*TypedSpecObject[any]]{}, WithKind("g1s2")), map[KindEncoding]Codec{KindEncodingJSON: &JSONCodec{}}}
		g2s1 := Kind{NewSimpleSchema("g2", "1", &TypedSpecObject[any]{}, &TypedList[*TypedSpecObject[any]]{}, WithKind("g2s1")), map[KindEncoding]Codec{KindEncodingJSON: &JSONCodec{}}}
		g2s2 := Kind{NewSimpleSchema("g2", "2", &TypedSpecObject[any]{}, &TypedList[*TypedSpecObject[any]]{}, WithKind("g2s2")), map[KindEncoding]Codec{KindEncodingJSON: &JSONCodec{}}}
...
func TestStore_Delete(t *testing.T) {
	...
	generator := &mockClientGenerator{}
	store := NewStore(generator)
	kind := Kind{NewSimpleSchema("g1", "v1", &TypedSpecObject[any]{}, &TypedList[*TypedSpecObject[any]]{}, WithKind("kind")), map[KindEncoding]Codec{KindEncodingJSON: &JSONCodec{}}}
	store.Register(kind)
	ctx := context.TODO()
