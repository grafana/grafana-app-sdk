...
func UpdateObject[T Object](ctx context.Context, client Client, identifier Identifier, updateFunc func(obj *T, isRetry bool) error, opts UpdateOptions) (T, error) {
	var empty T
	if client == nil {
	...
	doUpdate := func(obj T, isRetry bool) error {
		err = updateFunc(&obj, isRetry)
		if err != nil {
			return err
		}
