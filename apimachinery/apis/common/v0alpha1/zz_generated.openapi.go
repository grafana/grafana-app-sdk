...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/grafana/grafana-app-sdk/apimachinery/apis/common/v0alpha1.ObjectReference": schema_apimachinery_apis_common_v0alpha1_ObjectReference(ref),
		"github.com/grafana/grafana-app-sdk/apimachinery/apis/common/v0alpha1.Unstructured":    Unstructured{}.OpenAPIDefinition(),
