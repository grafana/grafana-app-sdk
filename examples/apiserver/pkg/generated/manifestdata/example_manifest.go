...
import (
	...
	testkindv0alpha1 "github.com/grafana/grafana-app-sdk/examples/apiserver/pkg/generated/testkind/v0alpha1"
	testkindv1alpha1 "github.com/grafana/grafana-app-sdk/examples/apiserver/pkg/generated/testkind/v1alpha1"
)
...
var kindVersionToGoType = map[string]resource.Kind{
	"TestKind/v0alpha1": testkindv0alpha1.Kind(),
	"TestKind/v1alpha1": testkindv1alpha1.Kind(),
}
...
var customRouteToGoResponseType = map[string]any{
	...
	"v1alpha1|TestKind|bar|GET": testkindv1alpha1.GetMessage{},

	"v1alpha1|TestKind|foo|GET": testkindv1alpha1.GetFoo{},

	"v1alpha1|TestKind|recurse|GET": testkindv1alpha1.GetRecursiveResponse{},
...
var customRouteToGoParamsType = map[string]runtime.Object{
	...
	"v1alpha1|TestKind|foo|GET": &testkindv1alpha1.GetFooRequestParamsObject{},
}
...
var customRouteToGoRequestBodyType = map[string]any{
	...
	"v1alpha1|TestKind|foo|GET": &testkindv1alpha1.GetFooRequestBody{},
