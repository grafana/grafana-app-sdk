...
func NewTestKindClient(client resource.Client) *TestKindClient {
	return &TestKindClient{
		client: resource.NewTypedClient[*TestKind, *TestKindList](client, Kind()),
	}
}
...
func (c *TestKindClient) UpdateMysubresource(ctx context.Context, identifier resource.Identifier, newMysubresource Mysubresource, opts resource.UpdateOptions) (*TestKind, error) {
...
func (c *TestKindClient) UpdateStatus(ctx context.Context, identifier resource.Identifier, newStatus Status, opts resource.UpdateOptions) (*TestKind, error) {
	return c.client.Update(ctx, &TestKind{
		TypeMeta: metav1.TypeMeta{
			Kind:       Kind().Kind(),
			APIVersion: GroupVersion.Identifier(),
