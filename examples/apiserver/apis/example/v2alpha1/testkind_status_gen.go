...
func (TestKindstatusOperatorState) OpenAPIModelName() string {
	return "com.github.grafana.grafana-app-sdk.examples.apiserver.apis.example.v2alpha1.TestKindstatusOperatorState"
}
...
func (TestKindStatus) OpenAPIModelName() string {
	return "com.github.grafana.grafana-app-sdk.examples.apiserver.apis.example.v2alpha1.TestKindStatus"
}
...
func (TestKindStatusOperatorStateState) OpenAPIModelName() string {
	return "com.github.grafana.grafana-app-sdk.examples.apiserver.apis.example.v2alpha1.TestKindStatusOperatorStateState"
}
