...
var (
	...
	rawSchemaTestKindv1alpha1     = []byte(`{"Bar":{"additionalProperties":false,"properties":{"baz":{"$ref":"#/components/schemas/Baz"},"value":{"default":"bar","type":"string"}},"required":["value","baz"],"type":"object"},"Baz":{"additionalProperties":false,"properties":{"value":{"default":10,"type":"integer"}},"required":["value"],"type":"object"},"Foo":{"additionalProperties":false,"properties":{"bar":{"$ref":"#/components/schemas/Bar"},"foo":{"default":"foo","type":"string"}},"required":["foo","bar"],"type":"object"},"OperatorState":{"additionalProperties":false,"properties":{"descriptiveState":{"description":"descriptiveState is an optional more descriptive state field which has no requirements on format","type":"string"},"details":{"additionalProperties":true,"description":"details contains any extra information that is operator-specific","type":"object"},"lastEvaluation":{"description":"lastEvaluation is the ResourceVersion last evaluated","type":"string"},"state":{"description":"state describes the state of the lastEvaluation.\nIt is limited to three possible states for machine evaluation.","enum":["success","in_progress","failed"],"type":"string"}},"required":["lastEvaluation","state"],"type":"object"},"Subresourcefoo":{"additionalProperties":false,"properties":{"someVal":{"type":"string"}},"required":["someVal"],"type":"object"},"TestKind":{"properties":{"foo":{"$ref":"#/components/schemas/Subresourcefoo"},"mysubresource":{"$ref":"#/components/schemas/mysubresource"},"spec":{"$ref":"#/components/schemas/spec"},"status":{"$ref":"#/components/schemas/status"}},"required":["spec"]},"getRecursiveResponseRecursiveType":{"type":"object","required":["message"],"properties":{"message":{"type":"string"},"next":{"$ref":"#/components/schemas/getRecursiveResponseRecursiveType"}},"additionalProperties":false},"mysubresource":{"additionalProperties":false,"properties":{"extraValue":{"type":"string"}},"required":["extraValue"],"type":"object"},"spec":{"additionalProperties":false,"properties":{"foo":{"$ref":"#/components/schemas/Foo"},"testField":{"default":"default value","type":"string"}},"required":["testField","foo"],"type":"object"},"status":{"additionalProperties":false,"properties":{"additionalFields":{"additionalProperties":true,"description":"additionalFields is reserved for future use","type":"object"},"operatorStates":{"additionalProperties":{"$ref":"#/components/schemas/OperatorState"},"description":"operatorStates is a map of operator ID to operator state evaluations.\nAny operator which consumes this kind SHOULD add its state evaluation information to this field.","type":"object"}},"type":"object"}}`)
