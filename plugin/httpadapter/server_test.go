...
func TestCallRouteErrors(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			called := false
			handler := NewServer(http.HandlerFunc(func(http.ResponseWriter, *http.Request) {
				called = true
			}))
...
func TestCallRouteReturnsStreamSendError(t *testing.T) {
	...
	handler := NewServer(http.HandlerFunc(func(rw http.ResponseWriter, _ *http.Request) {
...
func TestCallRouteWithoutOptionalRequestFields(t *testing.T) {
	...
	handler := NewServer(http.HandlerFunc(func(rw http.ResponseWriter, req *http.Request) {
