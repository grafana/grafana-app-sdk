...
issuev1alpha1: issueKind & {
	...
	// Mutation is used when generating the manifest to indicate support for mutation admission control
	// for this version. Here, we list that we want to do mutation for CREATE and UPDATE operations.
